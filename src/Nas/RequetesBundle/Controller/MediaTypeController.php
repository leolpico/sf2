...
use Nas\RequetesBundle\Entity\MediaType;
use Nas\RequetesBundle\Form\MediaTypeType;
...
class MediaTypeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('NasRequetesBundle:MediaType')->findAll();
     ...
     * @Method("POST")
     * @Template("NasRequetesBundle:MediaType:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('NasRequetesBundle:MediaType')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("NasRequetesBundle:MediaType:edit.html.twig")
     */
